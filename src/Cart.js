...
export const CartProvider = ({ children }) => {
  ...
  return (
    <CartContext.Provider value={{ cartItems, addToCart, updateQuantity, resetQuantity, removeItem, total, clearCart }}>
      {children}
...
function Cart() {
    const { cartItems, updateQuantity, resetQuantity, removeItem, total, clearCart } = useContext(CartContext);
      ...
      <div className="cart-container">
        ...
        <div className="cart-footer">
          ...
          <div className="total-checkout">
            ...
            <button type='submit' className="checkout" onClick={handleCheckout}>Checkout ›</button>
          </div>
        </div>
      </div>
    );
